...
import 'package:mobile/shared/components/inputCompleted.dart';
import 'package:mobile/shared/components/button.dart';
        ...
        children: [
          ...
          Button(
            ...
            onPressed: () async {
              ...
              if (context.mounted) {
                Navigator.of(context).pushReplacementNamed('/home-student');
              }
            },
          ),

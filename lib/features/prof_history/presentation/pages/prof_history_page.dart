...
class ProfHistoryPage extends ConsumerStatefulWidget {
  const ProfHistoryPage({super.key});

  @override
  ConsumerState<ProfHistoryPage> createState() => _ProfHistoryPageState();
}

class _ProfHistoryPageState extends ConsumerState<ProfHistoryPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(profHistoryProvider.notifier).fetchHistory();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final historyState = ref.watch(profHistoryProvider);

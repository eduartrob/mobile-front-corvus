          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    hasPro
                        ? 'Tu membresía incluye Inteligencia Artificial Multimodal por Voz, Resumen de Audio para Profesores y Dictámenes Ilimitados.'
                        : 'Puedes validar tus propuestas en modo básico o actualizar al Plan Pro para desbloquear el examen oral por voz.',
                    style: TextStyle(
            ...
            if (hasPro) ...[
              _buildFeatureRow(
                ...
                subtitle: 'Intercambio libre entre comandos de Voz HD y Redacción Escrita sin límites.',
                isIncluded: true,
              ),
              _buildFeatureRow(
                context,
                icon: Icons.record_voice_over_rounded,
                title: 'Simulador de Defensa por Voz HD',
                subtitle: 'Evaluación oral con voz neural es-MX-DaliaNeural y métricas de oratoria.',
                isIncluded: true,
              ),
              _buildFeatureRow(
                context,
                icon: Icons.workspace_premium_rounded,
                title: 'Expediente Pro & Audio Resumen (30s) para Profesores',
                subtitle: 'Garantía e Insignia Dorada para aprobación ejecutiva instantánea.',
                isIncluded: true,
              ),
              _buildFeatureRow(
                context,
                icon: Icons.picture_as_pdf_rounded,
                title: 'Validaciones Ilimitadas de PDF',
              ...
              _buildFeatureRow(
                context,
                icon: Icons.picture_as_pdf_rounded,
                title: 'Análisis Inicial de PDF',
                subtitle: 'Detección de innovación y recomendaciones de la IA.',
                isIncluded: true,
              ),
              _buildFeatureRow(
                context,
                icon: Icons.groups_rounded,
                title: 'Gestión de Equipo Académico',
                subtitle: 'Creación de grupos y colaboración con compañeros.',
                isIncluded: true,
              ),
              ...
              _buildFeatureRow(
                ...
                title: 'Simulador de Defensa Oral por Voz HD',
                subtitle: 'Requiere Plan Pro para hablar directamente con el jurado IA.',
                isIncluded: false,
              ),
              _buildFeatureRow(
                context,
                icon: Icons.subtitles_off_rounded,
                title: 'Audio Resumen (30s) e Insignia Dorada para Profesores',
                subtitle: 'Requiere Plan Pro para enviar reportes hablados al docente.',
                isIncluded: false,
              ),
            ],

                ...
                if (!_isHistoryExpanded) ...[
                  ...
                  Padding(
                    ...
                    child: Wrap(
                      ...
                      runSpacing: MediaQuery.sizeOf(context).height * 0.005,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      if (provider.currentResult!.links.isNotEmpty &&
                          !provider.currentResult!.summary.toLowerCase().contains('lo siento') &&
                          !provider.currentResult!.summary.toLowerCase().contains('lamentablemente') &&
                          !provider.currentResult!.summary.toLowerCase().contains('no hay suficiente información')) ...[
                        Text(
